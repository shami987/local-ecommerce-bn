 ...
 * /api/promotions:
 *   get:
 *     summary: Get all promotions (Public - visible to everyone)
 *     tags: [Promotions]
 *     responses:
 *       200:
 ...
 * /api/promotions/my:
 *   get:
 *     summary: Get business owner's own promotions (Protected)
 *     tags: [Promotions]
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 *         description: List of business owner's promotions
 *       401:
 *         description: Unauthorized
 */
router.get('/my', authenticateToken, getMyPromotions);
